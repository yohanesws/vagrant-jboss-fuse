...
echo "============ Create Fabric ============"
/home/vagrant/jboss-fuse-6.3.0.redhat-187/bin/client -r 3 -d 10 -u admin -p admin 'fabric:create --profile fabric --zookeeper-password admin --resolver localip --zookeeper-data-dir zkdata --wait-for-provisioning'
